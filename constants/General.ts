...
export const DefaultPageSizeMore = 100;
...
export const PurchaseFromFan = 'Secondary Market';
...
export const GlownetDeepLink = 'intent://launcher/#Intent;scheme=glownetapp;package=com.glownet.next.attended;end';
