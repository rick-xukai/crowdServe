                ...
                <Col className="detail-info">
                  ...
                  <Row className="info-card">
                    {data.status === CrowdFundStatus.inProgress && (
                      <Col span={24} className="ticket-number">
                        ...
                        <span className="">Tickets Pledged</span>
                      </Col>
                    )}
                    <Col
                      span={24}
                    ...
                    >
                      <Progress
                        percent={toPercent(data.raisedNumber, data.goalNumber)}
                        status={
                          (data.status !== CrowdFundStatus.failed &&
                            'active') ||
                          'normal'
                        ...
                        <>
                          {(data.status === CrowdFundStatus.succeeded && (
                            <Col className="price-content">
                              ...
                              <div className="price-text">{`by ${data.raisedNumber} backers help bring this project to life.`}</div>
                            </Col>
                          )) || (
                            <>
                              <Col className="price-content">
                                ...
                                <div className="price-text">total raised</div>
                              </Col>
                              <Col>
                                <div className="days">
                                  {(data.endTime &&
                                    ((getTimeDifference(data.endTime).days ===
                                      0 &&
                  ...
                  {data.status === CrowdFundStatus.inProgress && (
                    <Col className="info-card-description">
                      ...
                      <p>
                        Full refunds will be issued to all users if the event
                        goal is not met
                      </p>
                    </Col>
                  )}
                  <Col className="campaign-details-title">Campaign Details</Col>
                              ...
                              <>
                                ...
                                <Col span={8}>
                                  ...
                                  <div className="days-text">
                                    {`${formatDateText(data.endTime)} to go`}
                                  </div>
                                </Col>
                              </>
                            )) || (
